...
class Game:
    def __init__(self):
        ...
        self.dir_sounds = os.path.join(self.dir, "varios/sonidos")
        self.dir_images = os.path.join(self.dir, "varios/imagenes")
    ...
    def generate_coins(self):
        ...
        for c in range(0, MAX_NAVES):
            pos_x = random.randrange(last_position + 160, last_position + 300)
    ...
    def draw_text(self):
        ...
        if not self.playing:
            self.display_text("GAME OVER", 60, BLACK, WIDTH // 2, HEIGHT // 2)
    ...
    def menu(self):
        self.surface.fill(HONEYDEW)
        self.display_text("SUPERA LOS OBSTÁCULOS", 60, PERSIAN_GREEN, WIDTH // 2, HEIGHT // 2)
        self.display_text("Presiona ENTER para comenzar", 30, PERSIAN_GREEN, WIDTH // 2, 500)
